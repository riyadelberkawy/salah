...
function PrayTimes(method) {
  ...
  var // Time Names
    ...
    methods = {
      ...
      Hanafi: {
        name: "Muslim World League with hanafi asr",
        params: { fajr: 18, isha: 17, asr: "Hanafi" },
      },
    },
  ...
  return {
    ...
    computeTimes: function () {
      ...
      const result = this.modifyFormats(times);
      // remove midnight and sunset and imsak
      delete result.midnight;
      delete result.sunset;
      delete result.imsak;
      // make all keys first letter capital
      for (var i in result) {
        result[i.charAt(0).toUpperCase() + i.slice(1)] = result[i];
        delete result[i];
      }
      return result;
    },
